...
# Diagram.create!(name: "Diagramme de séquence,", type: "séquence,", description:"Il montre comment les objets interragissent les uns avec les autres", url:"....")
# Diagram.create!(name: "Diagramme de classe,", type: "uml," , description:"Il représente les différentes classes dans un système et permet de comprendre la structure du système et les relation entre les parties et comprendre comment les faire avancer", url: "..")
